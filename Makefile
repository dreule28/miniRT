...
RAY_TRACING_FILES := rays.c intersection.c surface_normals.c intersec_sphere.c intersec_to_list.c reflection.c lighting.c sort_obj_list.c comp_to_list.c view_tranformation.c camera.c shadows.c
