...
RAY_TRACING_FILES := rays.c intersection.c surface_normals.c intersec_sphere.c intersec_to_list.c reflection.c lighting.c sort_obj_list.c comp_to_list.c view_tranformation.c
...
MLX_FILES := mlx_hooks.c mlx_utils.c ray_tracing_loop.c paint_pixle.c camera.c
