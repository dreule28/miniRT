...
PARSER_FILES := fill_elements.c fill_objects.c initialize_objects.c list_and_nodes.c parser.c inits.c init_cubes.c translator.c translator_utils.c init_cone.c translate_cone.c init_triangles.c
