...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/09 14:59:41 by dreule            #+#    #+#             */
/*   Updated: 2025/09/09 14:59:42 by dreule           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_material	get_obj_mat(t_scene *scene)
{
	...
	else if (scene->obj_list->head->type == TRIANGLE)
		mat = scene->obj_list->head->data->triangle->material;
