...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/09 15:00:14 by dreule            #+#    #+#             */
/*   Updated: 2025/09/09 15:00:15 by dreule           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return (fabs(a.point.x - b.point.x) < DBL_EPSILON && fabs(a.point.y
			- b.point.y) < DBL_EPSILON && fabs(a.point.z
			- b.point.z) < DBL_EPSILON && fabs(a.eyev.x
			- b.eyev.x) < DBL_EPSILON && fabs(a.eyev.y - b.eyev.y) < DBL_EPSILON
	...
	while (curr)
	{
		if (comps_equal(curr->comp, comps))
		{
			if (curr->type == PLANE)
				...
				return (curr->data->triangle->material);
