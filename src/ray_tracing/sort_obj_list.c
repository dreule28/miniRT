...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/09 15:00:01 by dreule            #+#    #+#             */
/*   Updated: 2025/09/09 15:00:02 by dreule           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	should_swap_nodes(t_obj_node *curr, t_obj_node *next)
{
	...
	curr_valid = (curr->has_intersection && curr->t[0]) > 0;
	next_valid = (next->has_intersection && next->t[0]) > 0;
